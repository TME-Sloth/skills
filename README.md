...
| [sloth-d2c-auto-grouping](./sloth-d2c-auto-grouping/) | 消费 `subAgentTask-autoGrouping-*.md` 并写入 `.sloth/**/groupsData.json` 自动分组结果 |
| [sloth-d2c-components](./sloth-d2c-components/) | 消费 `subAgentTask-componentRegistration-*.md` 并维护 `.sloth/components.json` 组件库 |
